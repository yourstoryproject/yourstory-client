...
const TermsOfService = () => (
	<React.Fragment>
		<h2>Your Story Project Terms of Service</h2>
		<h3>1. Terms</h3>
		<p>
			By accessing the website at{' '}
			<a href="https://yourstoryproject.org">
				https://yourstoryproject.org
			</a>
		...
		<ol type="a">
			<li>
				...
				materials (information or software) on Your Story Project's
				...
				<ol type="i">
					...
					<li>
						...
						contained on Your Story Project's website;
					</li>
					<li>
			...
			<li>
				...
				these restrictions and may be terminated by Your Story Project
		...
		<ol type="a">
			<li>
				The materials on Your Story Project's website are provided on an
				'as is' basis. Your Story Project makes no warranties, expressed
			...
			<li>
				Further, Your Story Project does not warrant or make any
		...
		<h3>4. Limitations</h3>
		<p>
			In no event shall Your Story Project or its suppliers be liable for
			any damages (including, without limitation, damages for loss of data
			or profit, or due to business interruption) arising out of the use
			or inability to use the materials on Your Story Project's website,
			even if Your Story Project or a Your Story Project authorized
		...
		<p>
			The materials appearing on Your Story Project's website could
			include technical, typographical, or photographic errors. Your Story
			Project does not warrant that any of the materials on its website
			are accurate, complete or current. Your Story Project may make
			changes to the materials contained on its website at any time
			without notice. However Your Story Project does not make any
			commitment to update the materials.
		</p>
		<h3>6. Links</h3>
		<p>
			Your Story Project has not reviewed all of the sites linked to its
			website and is not responsible for the contents of any such linked
			site. The inclusion of any link does not imply endorsement by Your
			Story Project of the site. Use of any such linked website is at the
			user's own risk.
		</p>
		<h3>7. Modifications</h3>
		<p>
			Your Story Project may revise these terms of service for its website
